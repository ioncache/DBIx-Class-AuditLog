...
NOTE: As of v0.4.2 'quote_names' from L<DBIx::Class::Storage::DBI> is being enabled by the Audit Log.  This is to ensure that any of the table or column names used by the Audit Log don't conflict with any reserved words from any database.
