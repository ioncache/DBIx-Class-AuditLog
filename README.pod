...
In your application wrap any insert/update/delete in a transaction to have audit logging actiavted:
...
Optionally pass an extra hashref to the txn_do method to indicate a user and/or a description for audit:
